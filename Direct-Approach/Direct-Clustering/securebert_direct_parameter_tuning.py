...
print(f"The shape of X: {X.shape}") # (num_chunks=13076, embedding_dim=768)
...
SAVE_FILENAME = "securebert_direct_tuning_results.csv"
# CHANGE FILE PATH HERE
...
# run HDBSCAN with best parameters (securebert_direct_clustering.py)
